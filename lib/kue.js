...
exports.createQueue = function(base, range){
  return Queue.singleton = new Queue(base, range);
};
...
Queue.prototype.process = function(type, n, fn){
  ...
  while (n--) {
    setTimeout(function() {
      ...
      })(new Worker(this, type, self.base, self.range).start(fn));
    }, 2000 * i);
    i++;
  }
};
